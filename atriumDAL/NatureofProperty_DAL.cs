...
namespace atriumDAL
{
	...
	/// based on NatureofProperty table 
	/// in lawmate database
	/// on 3/12/2007
	/// </summary>
	public partial class NatureofPropertyDAL:atDAL.ObjectDAL
	{

    	internal NatureofPropertyDAL(atriumDALManager pDALManager) :base(pDALManager)
		  {
			  Init();
		  }
        ...
        private void Init()
		{
		  ...
		  new System.Data.Common.DataTableMapping("Table", "NatureofProperty", new System.Data.Common.DataColumnMapping[] {
		  
		  new System.Data.Common.DataColumnMapping("NatureofPropertyCode", "NatureofPropertyCode"),
		  new System.Data.Common.DataColumnMapping("PropertyDescEng", "PropertyDescEng"),
		  new System.Data.Common.DataColumnMapping("PropertyDescFre", "PropertyDescFre"),
		  ...
		  new System.Data.Common.DataColumnMapping("ts", "ts"),
			...
			this.sqlSelectAll.CommandText = "[NatureofPropertySelect]";
			...
			// sqlInsert
			// 
			this.sqlInsert.CommandText = "[NatureofPropertyInsert]";
			...
			this.sqlInsert.Parameters.Add(new SqlParameter("@PropertyDescEng", SqlDbType.NVarChar, 50, "PropertyDescEng"));
			this.sqlInsert.Parameters["@PropertyDescEng"].SourceVersion=DataRowVersion.Current;
			this.sqlInsert.Parameters.Add(new SqlParameter("@PropertyDescFre", SqlDbType.NVarChar, 50, "PropertyDescFre"));
			this.sqlInsert.Parameters["@PropertyDescFre"].SourceVersion=DataRowVersion.Current;
			...
			// sqlUpdate
			// 
			this.sqlUpdate.CommandText = "[NatureofPropertyUpdate]";
			...
			this.sqlUpdate.Parameters.Add(new SqlParameter("@PropertyDescEng", SqlDbType.NVarChar, 50, "PropertyDescEng"));
			this.sqlUpdate.Parameters["@PropertyDescEng"].SourceVersion=DataRowVersion.Current;
			this.sqlUpdate.Parameters.Add(new SqlParameter("@PropertyDescFre", SqlDbType.NVarChar, 50, "PropertyDescFre"));
			this.sqlUpdate.Parameters["@PropertyDescFre"].SourceVersion=DataRowVersion.Current;
			...
			// sqlDelete
			// 
			this.sqlDelete.CommandText = "[NatureofPropertyDelete]";
			this.sqlDelete.CommandType = System.Data.CommandType.StoredProcedure;
			this.sqlDelete.Connection=myDALManager.SqlCon;
			this.sqlDelete.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, false, ((System.Byte)(10)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
			this.sqlDelete.Parameters.Add(new System.Data.SqlClient.SqlParameter("@NatureofPropertyCode", System.Data.SqlDbType.NVarChar, 4, "NatureofPropertyCode"));
		    this.sqlDelete.Parameters["@NatureofPropertyCode"].SourceVersion=DataRowVersion.Original;
		 ...
		 public CodesDB.NatureofPropertyDataTable Load()
		{
			this.sqlDa.SelectCommand=sqlSelectAll;

            CodesDB.NatureofPropertyDataTable dt=new CodesDB.NatureofPropertyDataTable();
			Fill(dt);
            return dt;
        }
		...
		public CodesDB.NatureofPropertyDataTable Load(string NatureofPropertyCode)
		{
			this.sqlDa.SelectCommand=sqlSelect;
			this.sqlSelect.Parameters.Clear();
			this.sqlSelect.CommandText = "[NatureofPropertySelectByNatureofPropertyCode]";
