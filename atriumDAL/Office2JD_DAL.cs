...
namespace atriumDAL
{
	...
	/// based on Office2JD table 
	/// in lawmate database
	/// on 2006/06/16
	/// </summary>
	public partial class Office2JDDAL:atDAL.ObjectDAL
	{

    	internal Office2JDDAL(atriumDALManager pDALManager) :base(pDALManager)
		  {
			  Init();
		  }
        ...
        private void Init()
		{
		  ...
		  new System.Data.Common.DataTableMapping("Table", "Office2JD", new System.Data.Common.DataColumnMapping[] {
		  ...
		  new System.Data.Common.DataColumnMapping("ts", "ts"),
			...
			this.sqlSelectAll.CommandText = "[Office2JDSelect]";
			...
			// sqlInsert
			// 
			this.sqlInsert.CommandText = "[Office2JDInsert]";
			...
			this.sqlInsert.Parameters.Add(new SqlParameter("@JDCode", SqlDbType.NVarChar, 3, "JDCode"));
			...
			// sqlUpdate
			// 
			this.sqlUpdate.CommandText = "[Office2JDUpdate]";
			...
			this.sqlUpdate.Parameters.Add(new SqlParameter("@JDCode", SqlDbType.NVarChar, 3, "JDCode"));
			...
			// sqlDelete
			// 
			this.sqlDelete.CommandText = "[Office2JDDelete]";
		...
		public officeDB.Office2JDDataTable Load()
		{
			this.sqlDa.SelectCommand=sqlSelectAll;

            officeDB.Office2JDDataTable dt=new officeDB.Office2JDDataTable();
			Fill(dt);
            return dt;
        }
		...
		public officeDB.Office2JDDataTable Load(int OfficeId)
		{
			this.sqlDa.SelectCommand=sqlSelect;
			this.sqlSelect.Parameters.Clear();
			this.sqlSelect.CommandText = "[Office2JDSelectByOfficeId]";
