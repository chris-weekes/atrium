...
namespace atriumDAL
{
	...
	/// based on ADMSPIssues table 
	/// in atrium database
	/// on 11/26/2012
	/// </summary>
	public partial class ADMSPIssuesDAL:atDAL.ObjectDAL
	{

    	internal ADMSPIssuesDAL(atriumDALManager pDALManager) :base(pDALManager)
		  {
			  Init();
		  }
        ...
        private void Init()
		{
		  ...
		  new System.Data.Common.DataTableMapping("Table", "ADMSPIssues", new System.Data.Common.DataColumnMapping[] {
		  ...
		  new System.Data.Common.DataColumnMapping("ProgramBenefitCode", "ProgramBenefitCode"),
		  new System.Data.Common.DataColumnMapping("IssueCode", "IssueCode"),
		  ...
		  new System.Data.Common.DataColumnMapping("ts", "ts"),
			...
			this.sqlSelectAll.CommandText = "[ADMSPIssuesSelect]";
			...
			// sqlInsert
			// 
			this.sqlInsert.CommandText = "[ADMSPIssuesInsert]";
			...
			this.sqlInsert.Parameters.Add(new SqlParameter("@ProgramBenefitCode", SqlDbType.NVarChar, 10, "ProgramBenefitCode"));
			this.sqlInsert.Parameters["@ProgramBenefitCode"].SourceVersion=DataRowVersion.Current;
			this.sqlInsert.Parameters.Add(new SqlParameter("@IssueCode", SqlDbType.NVarChar, 10, "IssueCode"));
			this.sqlInsert.Parameters["@IssueCode"].SourceVersion=DataRowVersion.Current;
			...
			// sqlUpdate
			// 
			this.sqlUpdate.CommandText = "[ADMSPIssuesUpdate]";
			...
			this.sqlUpdate.Parameters.Add(new SqlParameter("@ProgramBenefitCode", SqlDbType.NVarChar, 10, "ProgramBenefitCode"));
			this.sqlUpdate.Parameters["@ProgramBenefitCode"].SourceVersion=DataRowVersion.Current;
			this.sqlUpdate.Parameters.Add(new SqlParameter("@IssueCode", SqlDbType.NVarChar, 10, "IssueCode"));
			this.sqlUpdate.Parameters["@IssueCode"].SourceVersion=DataRowVersion.Current;
			...
			// sqlDelete
			// 
			this.sqlDelete.CommandText = "[ADMSPIssuesDelete]";
		 ...
		 public SST.ADMSPIssuesDataTable Load()
		{
			this.sqlDa.SelectCommand=sqlSelectAll;

            SST.ADMSPIssuesDataTable dt=new SST.ADMSPIssuesDataTable();
			Fill(dt);
            return dt;
        }
		...
		public SST.ADMSPIssuesDataTable Load(int Id)
		{
			this.sqlDa.SelectCommand=sqlSelect;
			this.sqlSelect.Parameters.Clear();
			this.sqlSelect.CommandText = "[ADMSPIssuesSelectById]";
        ...
        public SST.ADMSPIssuesDataTable LoadByFileNumber(string SSTFileNumber)
        {
            this.sqlDa.SelectCommand = sqlSelect;
            this.sqlSelect.Parameters.Clear();
            this.sqlSelect.CommandText = "[ADMSPIssuesSelectBySSTFileNumber]";
            this.sqlSelect.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, false, ((System.Byte)(10)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
