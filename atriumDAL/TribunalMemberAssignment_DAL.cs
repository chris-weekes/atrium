...
namespace atriumDAL
{
    ...
    /// on 2013-11-27
    /// </summary>
    public partial class TribunalMemberAssignmentDAL : atDAL.ObjectDAL
    {

        internal TribunalMemberAssignmentDAL(atriumDALManager pDALManager)
            : base(pDALManager)
        {
            Init();
        }
        ...
        private void Init()
        {
		  ...
		  new System.Data.Common.DataTableMapping("Table", "TribunalMemberAssignment", new System.Data.Common.DataColumnMapping[] {
          ...
          new System.Data.Common.DataColumnMapping("TentativeMemberId", "TentativeMemberId"),
            ...
            this.sqlSelectAll.CommandText = "[TribunalMemberAssignment]";
            ...
            // sqlInsert
            // 
            //this.sqlInsert.CommandText = "[TribunalMemberAssignmentInsert]";
            ...
            // sqlUpdate
            // 
            this.sqlUpdate.CommandText = "[TribunalMemberAssignmentUpdate]";
            ...
            // sqlDelete
            // 
            //this.sqlDelete.CommandText = "[TribunalMemberAssignmentDelete]";
        ...
        public MemberManagement.TribunalMemberAssignmentDataTable Load()
        {
            this.sqlDa.SelectCommand = sqlSelectAll;

            MemberManagement.TribunalMemberAssignmentDataTable dt = new MemberManagement.TribunalMemberAssignmentDataTable();
            Fill(dt);
            return dt;
        }
        ...
        {
            return atriumDALManager.CompressData(Load());
        }
