...
namespace atriumDAL
{
	...
	/// based on AppointmentType table 
	/// in lawmate database
	/// on 3/12/2007
	/// </summary>
	public partial class AppointmentTypeDAL:atDAL.ObjectDAL
	{

    	internal AppointmentTypeDAL(atriumDALManager pDALManager) :base(pDALManager)
		  {
			  Init();
		  }
        ...
        private void Init()
		{
		  ...
		  new System.Data.Common.DataTableMapping("Table", "AppointmentType", new System.Data.Common.DataColumnMapping[] {
		  
		  new System.Data.Common.DataColumnMapping("AppointmentTypeCode", "AppointmentTypeCode"),
		  new System.Data.Common.DataColumnMapping("AppointmentTypeDescEng", "AppointmentTypeDescEng"),
		  new System.Data.Common.DataColumnMapping("AppointmentTypeDescFre", "AppointmentTypeDescFre"),
		  ...
		  new System.Data.Common.DataColumnMapping("ts", "ts"),
			...
			this.sqlSelectAll.CommandText = "[AppointmentTypeSelect]";
			...
			// sqlInsert
			// 
			this.sqlInsert.CommandText = "[AppointmentTypeInsert]";
			...
			this.sqlInsert.Parameters.Add(new SqlParameter("@AppointmentTypeDescEng", SqlDbType.NVarChar, 50, "AppointmentTypeDescEng"));
			this.sqlInsert.Parameters["@AppointmentTypeDescEng"].SourceVersion=DataRowVersion.Current;
			this.sqlInsert.Parameters.Add(new SqlParameter("@AppointmentTypeDescFre", SqlDbType.NVarChar, 50, "AppointmentTypeDescFre"));
			this.sqlInsert.Parameters["@AppointmentTypeDescFre"].SourceVersion=DataRowVersion.Current;
			...
			// sqlUpdate
			// 
			this.sqlUpdate.CommandText = "[AppointmentTypeUpdate]";
			...
			this.sqlUpdate.Parameters.Add(new SqlParameter("@AppointmentTypeDescEng", SqlDbType.NVarChar, 50, "AppointmentTypeDescEng"));
			this.sqlUpdate.Parameters["@AppointmentTypeDescEng"].SourceVersion=DataRowVersion.Current;
			this.sqlUpdate.Parameters.Add(new SqlParameter("@AppointmentTypeDescFre", SqlDbType.NVarChar, 50, "AppointmentTypeDescFre"));
			this.sqlUpdate.Parameters["@AppointmentTypeDescFre"].SourceVersion=DataRowVersion.Current;
			...
			// sqlDelete
			// 
			this.sqlDelete.CommandText = "[AppointmentTypeDelete]";
			this.sqlDelete.CommandType = System.Data.CommandType.StoredProcedure;
			this.sqlDelete.Connection=myDALManager.SqlCon;
			this.sqlDelete.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, false, ((System.Byte)(10)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
			this.sqlDelete.Parameters.Add(new System.Data.SqlClient.SqlParameter("@AppointmentTypeCode", System.Data.SqlDbType.NVarChar, 4, "AppointmentTypeCode"));
		    this.sqlDelete.Parameters["@AppointmentTypeCode"].SourceVersion=DataRowVersion.Original;
