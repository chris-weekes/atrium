...
namespace lawmateDAL
{
	/// <summary>
	/// Class generated by sgen 
	/// based on ACMandate table 
	/// in lawmate database
	/// on 2/6/2007
	/// </summary>
	public partial class ACMandateDAL:atDAL.ObjectDAL
	{

    	internal ACMandateDAL(lawmateDALManager pDALManager) :base(pDALManager)
		  {
			  Init();
		  }
        ...
        private void Init()
		{
		  ...
		  new System.Data.Common.DataTableMapping("Table", "ACMandate", new System.Data.Common.DataColumnMapping[] {
		  
		  new System.Data.Common.DataColumnMapping("Id", "Id"),
		  new System.Data.Common.DataColumnMapping("ActivityCodeId", "ActivityCodeId"),
		  new System.Data.Common.DataColumnMapping("MandateId", "MandateId"),
		  ...
		  new System.Data.Common.DataColumnMapping("ts", "ts"),
			...
			this.sqlSelectAll.CommandText = "[ACMandateSelect]";
			...
			// sqlInsert
			// 
			this.sqlInsert.CommandText = "[ACMandateInsert]";
			...
			this.sqlInsert.Parameters.Add(new SqlParameter("@MandateId", SqlDbType.Int, 10, "MandateId"));
			this.sqlInsert.Parameters["@MandateId"].SourceVersion=DataRowVersion.Current;
			...
			// sqlUpdate
			// 
			this.sqlUpdate.CommandText = "[ACMandateUpdate]";
			...
			this.sqlUpdate.Parameters.Add(new SqlParameter("@MandateId", SqlDbType.Int, 10, "MandateId"));
			this.sqlUpdate.Parameters["@MandateId"].SourceVersion=DataRowVersion.Current;
			...
			// sqlDelete
			// 
			this.sqlDelete.CommandText = "[ACMandateDelete]";
		 ...
		 override public lawmateDB.ACMandateDataTable Load()
		{
			this.sqlDa.SelectCommand=sqlSelectAll;

            lawmateDB.ACMandateDataTable dt=new lawmateDB.ACMandateDataTable();
			Fill(dt);
            return dt;
        }
		...
		public lawmateDB.ACMandateDataTable Load(int Id)
		{
			this.sqlDa.SelectCommand=sqlSelect;
			this.sqlSelect.Parameters.Clear();
			this.sqlSelect.CommandText = "[ACMandateSelectById]";
		...
		public lawmateDB.ACMandateDataTable LoadByActivityCodeId(int ActivityCodeId)
		{
			this.sqlDa.SelectCommand=sqlSelect;
			this.sqlSelect.Parameters.Clear();
			this.sqlSelect.CommandText = "[ACMandateSelectByActivityCodeId]";
			this.sqlSelect.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, false, ((System.Byte)(10)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
		...
		public lawmateDB.ACMandateDataTable LoadByMandateId(int MandateId)
		{
			this.sqlDa.SelectCommand=sqlSelect;
			this.sqlSelect.Parameters.Clear();
			this.sqlSelect.CommandText = "[ACMandateSelectByMandateId]";
			this.sqlSelect.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, false, ((System.Byte)(10)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
			this.sqlSelect.Parameters.Add(new System.Data.SqlClient.SqlParameter("@MandateId", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, false, ((System.Byte)(10)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
			this.sqlSelect.Parameters["@MandateId"].Value=MandateId;
