...
namespace atriumDAL
{
	...
	/// based on ApptRecurrenceType table 
	/// in Lawmate_DEV database
	/// on 2015-01-22
	/// </summary>
	public partial class ApptRecurrenceTypeDAL:atDAL.ObjectDAL
	{
        ...
        private void Init()
		{
		  ...
		  new System.Data.Common.DataTableMapping("Table", "ApptRecurrenceType", new System.Data.Common.DataColumnMapping[] {
		  
		  new System.Data.Common.DataColumnMapping("ApptRecurrenceTypeID", "ApptRecurrenceTypeID"),
		  new System.Data.Common.DataColumnMapping("ApptRecurrenceTypeDescEng", "ApptRecurrenceTypeDescEng"),
		  new System.Data.Common.DataColumnMapping("ApptRecurrenceTypeDescFre", "ApptRecurrenceTypeDescFre"),
		  ...
		  new System.Data.Common.DataColumnMapping("ts", "ts"),
			...
			this.sqlSelectAll.CommandText = "[ApptRecurrenceTypeSelect]";
			...
			// sqlInsert
			// 
			this.sqlInsert.CommandText = "[ApptRecurrenceTypeInsert]";
			...
			this.sqlInsert.Parameters.Add(new SqlParameter("@ApptRecurrenceTypeDescEng", SqlDbType.NVarChar, 50, "ApptRecurrenceTypeDescEng"));
			this.sqlInsert.Parameters["@ApptRecurrenceTypeDescEng"].SourceVersion=DataRowVersion.Current;
			this.sqlInsert.Parameters.Add(new SqlParameter("@ApptRecurrenceTypeDescFre", SqlDbType.NVarChar, 50, "ApptRecurrenceTypeDescFre"));
			this.sqlInsert.Parameters["@ApptRecurrenceTypeDescFre"].SourceVersion=DataRowVersion.Current;
			...
			// sqlUpdate
			// 
			this.sqlUpdate.CommandText = "[ApptRecurrenceTypeUpdate]";
			...
			this.sqlUpdate.Parameters.Add(new SqlParameter("@ApptRecurrenceTypeDescEng", SqlDbType.NVarChar, 50, "ApptRecurrenceTypeDescEng"));
			this.sqlUpdate.Parameters["@ApptRecurrenceTypeDescEng"].SourceVersion=DataRowVersion.Current;
			this.sqlUpdate.Parameters.Add(new SqlParameter("@ApptRecurrenceTypeDescFre", SqlDbType.NVarChar, 50, "ApptRecurrenceTypeDescFre"));
			this.sqlUpdate.Parameters["@ApptRecurrenceTypeDescFre"].SourceVersion=DataRowVersion.Current;
			...
			// sqlDelete
			// 
			this.sqlDelete.CommandText = "[ApptRecurrenceTypeDelete]";
			this.sqlDelete.CommandType = System.Data.CommandType.StoredProcedure;
			this.sqlDelete.Connection=myDALManager.SqlCon;
			this.sqlDelete.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, false, ((System.Byte)(10)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
			this.sqlDelete.Parameters.Add(new System.Data.SqlClient.SqlParameter("@ApptRecurrenceTypeID", System.Data.SqlDbType.Int, 4, "ApptRecurrenceTypeID"));
		    this.sqlDelete.Parameters["@ApptRecurrenceTypeID"].SourceVersion=DataRowVersion.Original;
