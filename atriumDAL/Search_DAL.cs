...
namespace atriumDAL
{
	...
	/// based on Search table 
	/// in atriumcomp database
	/// on 11/25/2014
	/// </summary>
	public partial class SearchDAL:atDAL.ObjectDAL
	{

    	internal    SearchDAL(atriumDALManager pDALManager) :base(pDALManager)
		  {
			  Init();
		  }
        ...
        private void Init()
        {
          ...
          new System.Data.Common.DataTableMapping("Table", "Search", new System.Data.Common.DataColumnMapping[] {
          ...
          new System.Data.Common.DataColumnMapping("Type", "Type"),
            ...
            this.sqlSelectAll.CommandText = "[SearchSelect]";
            ...
            // sqlInsert
            // 
            this.sqlInsert.CommandText = "[SearchInsert]";
            ...
            this.sqlInsert.Parameters.Add(new SqlParameter("@NameE", SqlDbType.NVarChar, 50, "NameE"));
            this.sqlInsert.Parameters["@NameE"].SourceVersion = DataRowVersion.Current;
            this.sqlInsert.Parameters.Add(new SqlParameter("@NameF", SqlDbType.NVarChar, 50, "NameF"));
            ...
            // sqlUpdate
            // 
            this.sqlUpdate.CommandText = "[SearchUpdate]";
            ...
            this.sqlUpdate.Parameters.Add(new SqlParameter("@NameE", SqlDbType.NVarChar, 50, "NameE"));
            this.sqlUpdate.Parameters["@NameE"].SourceVersion = DataRowVersion.Current;
            this.sqlUpdate.Parameters.Add(new SqlParameter("@NameF", SqlDbType.NVarChar, 50, "NameF"));
            ...
            // sqlDelete
            // 
            this.sqlDelete.CommandText = "[SearchDelete]";
        ...
        public appDB.SearchDataTable Load()
		{
			this.sqlDa.SelectCommand=sqlSelectAll;

            appDB.SearchDataTable dt = new appDB.SearchDataTable();
			Fill(dt);
            return dt;
        }
        ...
        public appDB.SearchDataTable Load(int Id)
        {
            this.sqlDa.SelectCommand = sqlSelect;
            this.sqlSelect.Parameters.Clear();
            this.sqlSelect.CommandText = "[SearchSelectById]";
