...
namespace atriumDAL
{
	...
	/// based on FileType table 
	/// in lawmate database
	/// on 3/12/2007
	/// </summary>
	public partial class FileTypeDAL:atDAL.ObjectDAL
	{

    	internal FileTypeDAL(atriumDALManager pDALManager) :base(pDALManager)
		  {
			  Init();
		  }
        ...
        private void Init()
		{
		  ...
		  new System.Data.Common.DataTableMapping("Table", "FileType", new System.Data.Common.DataColumnMapping[] {
		  ...
		  new System.Data.Common.DataColumnMapping("FileTypeMajor", "FileTypeMajor"),
		  ...
		  new System.Data.Common.DataColumnMapping("ts", "ts"),
              new System.Data.Common.DataColumnMapping("ChildFileType", "ChildFileType"),
			})});
			...
			this.sqlSelectAll.CommandText = "[FileTypeSelect]";
			...
			// sqlInsert
			// 
			this.sqlInsert.CommandText = "[FileTypeInsert]";
            ...
            this.sqlInsert.Parameters.Add(new SqlParameter("@FileTypeMajor", SqlDbType.NVarChar, 4, "FileTypeMajor"));
            this.sqlInsert.Parameters["@FileTypeMajor"].SourceVersion = DataRowVersion.Current;
            ...
            this.sqlInsert.Parameters.Add(new SqlParameter("@ChildFileType", SqlDbType.NVarChar, 6, "ChildFileType"));
            this.sqlInsert.Parameters["@ChildFileType"].SourceVersion = DataRowVersion.Current;

			// 
			// sqlUpdate
			// 
			this.sqlUpdate.CommandText = "[FileTypeUpdate]";
            ...
            this.sqlUpdate.Parameters.Add(new SqlParameter("@FileTypeMajor", SqlDbType.NVarChar, 4, "FileTypeMajor"));
            this.sqlUpdate.Parameters["@FileTypeMajor"].SourceVersion = DataRowVersion.Current;
            ...
            this.sqlUpdate.Parameters.Add(new SqlParameter("@ChildFileType", SqlDbType.NVarChar, 6, "ChildFileType"));
            this.sqlUpdate.Parameters["@ChildFileType"].SourceVersion = DataRowVersion.Current;

			// 
			// sqlDelete
			// 
			this.sqlDelete.CommandText = "[FileTypeDelete]";
			this.sqlDelete.CommandType = System.Data.CommandType.StoredProcedure;
			this.sqlDelete.Connection=myDALManager.SqlCon;
			this.sqlDelete.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, false, ((System.Byte)(10)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
			this.sqlDelete.Parameters.Add(new System.Data.SqlClient.SqlParameter("@FileTypeCode", System.Data.SqlDbType.NVarChar, 6, "FileTypeCode"));
		 ...
		 public CodesDB.FileTypeDataTable Load()
		{
			this.sqlDa.SelectCommand=sqlSelectAll;

            CodesDB.FileTypeDataTable dt=new CodesDB.FileTypeDataTable();
			Fill(dt);
            return dt;
        }
		...
		public CodesDB.FileTypeDataTable Load(string FileTypeCode)
		{
			this.sqlDa.SelectCommand=sqlSelect;
			this.sqlSelect.Parameters.Clear();
			this.sqlSelect.CommandText = "[FileTypeSelectByFileTypeCode]";
			this.sqlSelect.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, false, ((System.Byte)(10)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
			this.sqlSelect.Parameters.Add(new System.Data.SqlClient.SqlParameter("@FileTypeCode", System.Data.SqlDbType.NVarChar, 6, System.Data.ParameterDirection.Input, false, ((System.Byte)(10)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
