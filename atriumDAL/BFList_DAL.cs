...
namespace atriumDAL
{
	...
	/// based on BFList table 
	/// in lawmate database
	/// on 2006/06/16
	/// </summary>
	public partial class BFListDAL:atDAL.ObjectDAL
	{

    	internal BFListDAL(atriumDALManager pDALManager) :base(pDALManager)
		  {
			  Init();
		  }
        ...
        private void Init()
		{
		  ...
		  new System.Data.Common.DataTableMapping("Table", "BFList", new System.Data.Common.DataColumnMapping[] {
		  ...
		  new System.Data.Common.DataColumnMapping("ts", "ts"),
			...
			this.sqlSelectAll.CommandText = "[BFListSelect]";
			...
			// sqlInsert
			// 
			this.sqlInsert.CommandText = "[BFListInsert]";
			...
			this.sqlInsert.Parameters.Add(new SqlParameter("@Type", SqlDbType.TinyInt, 50, "Type"));
			...
			// sqlUpdate
			// 
			this.sqlUpdate.CommandText = "[BFListUpdate]";
			...
			this.sqlUpdate.Parameters.Add(new SqlParameter("@Type", SqlDbType.TinyInt, 50, "Type"));
			...
			// sqlDelete
			// 
			this.sqlDelete.CommandText = "[BFListDelete]";
			this.sqlDelete.CommandType = System.Data.CommandType.StoredProcedure;
			this.sqlDelete.Connection=myDALManager.SqlCon;
			this.sqlDelete.Parameters.Add(new System.Data.SqlClient.SqlParameter("@RETURN_VALUE", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.ReturnValue, false, ((System.Byte)(10)), ((System.Byte)(0)), "", System.Data.DataRowVersion.Current, null));
			this.sqlDelete.Parameters.Add(new System.Data.SqlClient.SqlParameter("@OfficerID", System.Data.SqlDbType.Int, 10, "OfficerID"));
		...
		public override atriumDB.BFListDataTable Load()
		{
			this.sqlDa.SelectCommand=sqlSelectAll;

            atriumDB.BFListDataTable dt=new atriumDB.BFListDataTable();
			Fill(dt);
            return dt;
        }
		...
		public atriumDB.BFListDataTable Load(int OfficerID)
		{
			this.sqlDa.SelectCommand=sqlSelect;
			this.sqlSelect.Parameters.Clear();
			this.sqlSelect.CommandText = "[BFListSelectByOfficerID]";
