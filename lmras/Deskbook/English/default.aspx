<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="lmras.Deskbook.English._default" %>
...
<div id="cn-body-inner-2col">
	...
	<header>
		...
		<div id="cn-banner" role="banner">
			...
			<p><a href="#"><asp:Literal ID="AppNameEng" runat="server"></asp:Literal></a></p>
		</div>
