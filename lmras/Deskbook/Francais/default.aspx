<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="lmras.Deskbook.Francais._default" %>
...
<head id="Head1" runat="server">
	...
	<!-- TemplateBeginEditable name="Titre français | French title" -->
	<title>Manuels d'instructions Atrium</title>
	<!-- TemplateEndEditable -->
	...
	<meta name="dcterms.spatial" title="" content="" /> 
...
<div id="cn-body-inner-2col">
	...
	<header>
        <!-- clf2-nsi2 theme begins / Début du thème clf2-nsi2 -->
        <div id="cn-wmms"><img src="../wet20/theme-clf2-nsi2/images/wmms.gif" width="83" height="20" alt="Symbole du gouvernement du Canada" title="Symbole du gouvernement du Canada" /></div>

		<!-- Banner begins / Début de la bannière -->
		<div id="cn-leaf"></div>
		<div id="cn-banner" role="banner">
			<p id="cn-banner-text"><a href="../francais/">Manuels d'instructions Atrium</a></p>
			<p><a href="#"><asp:Literal ID="AppNameFre" runat="server"></asp:Literal></a></p>
		</div>
		...
		<nav role="navigation">
			...
			<div id="cn-cmb">
				...
				<ul>
					<li id="cn-cmb1">
					<!-- TemplateBeginEditable name="Lien anglais | English link" -->
					<asp:Literal ID="fLang" runat="server"></asp:Literal>
					<!-- TemplateEndEditable -->
					</li>
					<li id="cn-cmb2"><a href="SiteMap.aspx">plan du site</a></li>
...
<!-- clf2-nsi2 theme ends / Fin du thème clf2-nsi2 -->
	...
	<div id="cn-centre-col" role="main"><div id="cn-centre-col-inner">
        <section>
          ...
          <header>
            <h1 id="cn-cont">
			<!-- TemplateBeginEditable name="Titre contenu français | French content title" -->
          ...
          <!-- clf2-nsi2 theme begins / Début du thème clf2-nsi2 -->
	      <!-- TemplateBeginEditable name="Contenu français | French content" -->
    	  <div class="span">
...
<!-- CSS Grid System ends / Fin du système de grille de CSS -->
	...
	<section>
		<h2 id="cn-nav">Navigation principale (colonne gauche)</h2>
		<div class="cn-left-col-default">
		<nav role="navigation">
<!-- clf2-nsi2 theme begins / Début du thème clf2-nsi2 -->
			<section>
				<!-- TemplateBeginEditable name="Menu latéral | Side menu" -->
...
<!-- UI personalisation begins / Début de la personnalisation de la IU -->
			<!--<section>
				<div class="utilities">
					<ul>
						<li><a href="?pgid=37" class="utility-search">Recherche</a></li>
						<li><a href="?pgid=36" class="utility-feedback">Commentaires</a></li>
						<li><a href="?pgid=93" class="utility-sitemap">Carte du site</a></li>
					</ul>
				</div>
			</section>-->
...
<!-- clf2-nsi2 theme begins / Début du thème clf2-nsi2 -->
		<div id="cn-in-pd">			
			...
			<div id="cn-toppage-foot"><a href="#cn-tphp">Haut de la page</a></div>
