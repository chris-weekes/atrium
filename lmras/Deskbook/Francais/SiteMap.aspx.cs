...
namespace lmras.Deskbook.Francais
{
    public partial class _SiteMap : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            pageElement = xn;
            dcSubject = (pageElement.Attributes["dcSubjectFra"] != null) ? pageElement.Attributes["dcSubjectFrag"].Value : "";
            dcDesc = (pageElement.Attributes["dcDescriptionFra"] != null) ? pageElement.Attributes["dcDescriptionFra"].Value : "";
            dcKeywords = (pageElement.Attributes["keywordsFra"] != null) ? pageElement.Attributes["keywordsFra"].Value : "";
            ...
            //DoPageContent();
            //pgBcXml.Text = HelpHelper.DoBreadcrumb(atDal, xmlMenu, PgId, "fra");
            //pgMenuXml.Text = HelpHelper.DoMenu("fra", xmlMenu, PgId, atDal);
        }
        ...
        private void showList(string nodeToHighlight, XmlDocument LinkData_filename)
        {
            ...
            XslCompiledTransform xslStructure = HelpHelper.LoadXslTransformFile2("deskbook_manual_selectf.xsl", DESKBOOK_SAM_PATH_XSL, atDal, false);
        ...
        private void DoPageContent()
        {
            ...
            {
                lmDatasets.HelpDB.hlpPageRow pgRow = HelpHelper.RetrievePageContent(pageElement.Attributes["path"].Value, "fra", atDal);
                if (pgRow != null)
                {
