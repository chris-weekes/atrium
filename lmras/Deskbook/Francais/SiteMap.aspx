<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SiteMap.aspx.cs" Inherits="lmras.Deskbook.Francais._SiteMap" %>
...
<body>
    ...
    <div id="cn-body-inner-2col">
		...
		<div id="cn-banner" role="banner">
			...
			<p><a href="#">Tribunal de la sécurité sociale</a></p>
		</div>
				...
				<ul>
					<li id="cn-cmb1">
                        <!--
                            ...
                            -->
                        <a href="/lmras/deskbook/francais/">page d'accueil</a>
