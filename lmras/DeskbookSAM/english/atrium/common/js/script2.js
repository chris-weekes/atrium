    ...
    try {
        if (escapeKey == event.keyCode) {
            ...
            if (CurrentCutItem != null) {
                ...
                contextMenu.children["PasteItem"].innerHTML = '<img src="../../DeskbookSAM/english/atrium/content_manager/images/paste.png" border="0" alt="" height="16" width="16" style="margin-right:12px;vertical-align:middle;"/>Paste as Child';
                ...
                contextMenu.children["PasteBrotherItem"].innerHTML = '<img src="../../DeskbookSAM/english/atrium/content_manager/images/paste.png" border="0" alt="" height="16" width="16" style="margin-right:12px;vertical-align:middle;"/>Paste as Sibiling';
...
function tbExpand(img, textarea, span) {
    ...
    if (span.style.display == 'none') {
        img.src = '../../DeskbookSAM/english/atrium/content_manager/images/minus.gif';
        event.srcElement.parentElement.className = 'toolbarTitle';
        span.style.display = '';
    }
    else {
        img.src = '../../DeskbookSAM/english/atrium/content_manager/images/plus.gif';
...
function CutContainer() {
    ...
    contextMenu.children["PasteBrotherItem"].disabled = false;
    contextMenu.children["PasteBrotherItem"].className = "menAnc";
    contextMenu.children["PasteBrotherItem"].innerHTML = '<img src="../../DeskbookSAM/english/atrium/content_manager/images/paste.png" border="0" alt="" height="16" width="16" style="margin-right:12px;vertical-align:middle;"/>Paste as Sibling';
...
function ExpandCollapseAll()
{
	...
	for(i=0;i<AncTags.length;i++)
	{
		if(AncTags[i].vid=="xc")
		{
			if(event.srcElement.init=="1")
			{
			    AncTags[i].innerHTML = "<img src='../../DeskbookSAM/english/atrium/content_manager/images/plus.gif' border='0' style='margin-right:4px;'/>";
			    //$.cookie(AncTags[i].id, 'Collapsed', { expires: 2 });
			    ckState += AncTags[i].id;
            }
			else
			{
			    AncTags[i].innerHTML = "<img src='../../DeskbookSAM/english/atrium/content_manager/images/minus.gif' border='0' style='margin-right:4px;'/>";
			    //$.cookie(AncTags[i].id, 'Expanded', { expires: 2 });
            }
		}
	}
...
function scrollToNode()
{
	...
	//{
    var src = "scrollTo" + location.hash;// document.all.oHighlightNode.value;
...
function CollapseSection(vulid, isSelector) {
	...
	if (srcElm.innerHTML.indexOf('../../DeskbookSAM/english/atrium/content_manager/images/plus.gif') != -1) {
	...
	for(i=0;i<ulidTags.length;i++) {
		...
		if(ulidTags[i].ulid==vulid)
		{
			if(ulidTags[i].style.display=="none")
			{
				...
				srcElm.innerHTML = "<img src='"+imgSource+"../../DeskbookSAM/english/atrium/content_manager/images/minus.gif' border='0' style='margin-right:4px;'/>";
			}
			else
			{
			    ulidTags[i].style.display="none";
				srcElm.innerHTML = "<img src='"+imgSource+"../../DeskbookSAM/english/atrium/content_manager/images/plus.gif' border='0' style='margin-right:4px;'/>";
			}
		}
	}
...
function SetCollapseExpandSections()
{
	...
	for(i=0;i<ulidTags.length;i++)
	{
		if(ulidTags[i].top)
		{
			...
			if (expColText!=null && expColText.indexOf(colId)>=0)
			{
			    //alert("collapsed!");
			    //alert(i);
			    //alert(colId);
			    ancElement.innerHTML = "<img src='../../DeskbookSAM/english/atrium/content_manager/images/plus.gif' border='0' style='margin-right:4px;'/>";
				ulidTags[i].style.display="none";
			}
			else
			{
			    ancElement.innerHTML = "<img src='../../DeskbookSAM/english/atrium/content_manager/images/minus.gif'  border='0' style='margin-right:4px;'/>";
				ulidTags[i].style.display="";
			}
		}
	}
