  ...
  <xsl:template match="/">
    ...
    <div id="contextMenu" name="divMenu" class="men" style="display:none;z-index:200;width:180px;" onclick="clearAll();">
      <a class="menAnc" name="insNode" href="javascript:" onclick="location='SAMStructure.aspx?pgid={$pgid}&amp;nodetype=node&amp;parentId='+this.parentElement.srcId;return false">
        <img src="../../DeskbookSAM/english/atrium/content_manager/images/section.png" border="0" alt="" height="16" width="16" style="margin-right:12px;vertical-align:middle;"/>Insert New Section
      </a>
      <a class="menAnc" name="insLeafSection" href="javascript:" onclick="location='SAMStructure.aspx?pgid={$pgid}&amp;nodetype=nodeleaf&amp;parentId='+this.parentElement.srcId;return false">
        <img src="../../DeskbookSAM/english/atrium/content_manager/images/leafsection.png" border="0" alt="" height="16" width="16" style="margin-right:12px;vertical-align:middle;"/>Insert New Leaf (W/ Section)
      </a>
      <a class="menAnc" name="insLeaf" href="javascript:" onclick="location='SAMStructure.aspx?pgid={$pgid}&amp;nodetype=leaf&amp;parentId='+this.parentElement.srcId;return false">
        <img src="../../DeskbookSAM/english/atrium/content_manager/images/leaf.png" border="0" alt="" height="16" width="16" style="margin-right:12px;vertical-align:middle;"/>Insert New Leaf
      </a>
      <a class="menAnc" name="moveUp" href="javascript:" onclick="location='SAMStructure.aspx?pgid={$pgid}&amp;move=up&amp;moveid='+this.parentElement.srcId;return false">
        <img src="../../DeskbookSAM/english/atrium/content_manager/images/arrUp.gif" border="0" alt="" height="16" width="16" style="margin-right:12px;vertical-align:middle;"/>Move Item Up
      </a>
      <a class="menAnc" name="moveDown" href="javascript:" onclick="location='SAMStructure.aspx?pgid={$pgid}&amp;move=down&amp;moveid='+this.parentElement.srcId;return false">
        <img src="../../DeskbookSAM/english/atrium/content_manager/images/arrdown.gif" border="0" alt="" height="16" width="16" style="margin-right:12px;vertical-align:middle;"/>Move Item Down
      </a>
      <a class="menAnc" name="CutItem" href="javascript:" onclick="CutTreeViewItem();">
        <img src="../../DeskbookSAM/english/atrium/content_manager/images/cut.png" border="0" alt="" height="16" width="16" style="margin-right:12px;vertical-align:middle;"/>Cut
      </a>
      <a class="menAncDisabled" disabled="true" name="PasteItem" href="javascript:" onclick="event.cancelBubble=true;location='SAMStructure.aspx?pgid={$pgid}&amp;paste=Y&amp;ParentItem='+this.parentElement.srcId+'&amp;PasteItem='+CurrentCutItem.getAttribute('data-itemid');return false">
        <img src="../../DeskbookSAM/english/atrium/content_manager/images/paste.png" border="0" alt="" height="16" width="16" style="margin-right:12px;vertical-align:middle;"/>as Child
      </a>
      <a class="menAncDisabled" disabled="true" name="PasteBrotherItem" href="javascript:" onclick="event.cancelBubble=true;location='SAMStructure.aspx?pgid={$pgid}&amp;paste=Y&amp;parent=N&amp;ParentItem='+this.parentElement.srcId+'&amp;PasteItem='+CurrentCutItem.getAttribute('data-itemid');return false">
        <img src="../../DeskbookSAM/english/atrium/content_manager/images/paste.png" border="0" alt="" height="16" width="16" style="margin-right:12px;vertical-align:middle;"/>Same Level
      </a>
      <a class="menAnc" name="editOpen" href="javascript:" onclick="launchEditorWindow(this.parentElement.srcId,'eng' );">
        <img src="../../DeskbookSAM/english/atrium/content_manager/images/section.png" border="0" alt="" height="16" width="16" style="margin-right:12px;vertical-align:middle;"/>Open in SAM Editor
      </a>
    </div>
    ...
    <li class="li">
      <xsl:if test="@id!='1'">
        ...
        <a class="CXLink" id="ExpCol{@id}" vid="xc" href="javascript:CollapseSection({@id}, false);">
          <IMG class="img" WIDTH="16" src="../../DeskbookSAM/english/atrium/content_manager/images/minus.gif" />
        </a>
      </xsl:if>
      <xsl:if test="@nodeType='node'">
        <IMG class="img" WIDTH="16" src="../../DeskbookSAM/english/atrium/content_manager/images/section.png" />
      </xsl:if>
      <xsl:if test="@nodeType='nodeleaf'">
        <IMG class="img" WIDTH="16" src="../../DeskbookSAM/english/atrium/content_manager/images/leafSection.png" />
      </xsl:if>
      <xsl:if test="@nodeType='leaf'">
        <IMG class="img" WIDTH="16" src="../../DeskbookSAM/english/atrium/content_manager/images/leaf.png" />
      </xsl:if>
      <xsl:choose>
          ...
          <strong>
            <a class="mnItm" id="scrollTo{@id}" data-itemid="{@id}" ItemId="{@id}" levelCount="{count(ancestor::item)}">
              ...
              <xsl:attribute name="HREF">
                Default.aspx?pgid=<xsl:value-of select="@pgid"/>
              </xsl:attribute>
