<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SAMImageSelector.aspx.cs" Inherits="SSTDeskBooks.english.atrium.content_manager.SAMImageSelector" %>
...
<head>
    ...
    <meta name="dc.subject" title="SST Deskbook Site Admin Module" content="" />
    ...
    <script type="text/javascript">
        ...
        function returnImgTag(imgsrc) {
            returnValue = "<img src=\"../res.aspx?f=" + imgsrc.replace(/ /g, '+') + "\" alt=\"\"/>";
            self.close();
        }
...
<body onunload="leavingDialog();" style="width: 780px;">
